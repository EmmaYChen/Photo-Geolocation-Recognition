...
if __name__ == '__main__':
    ...
    model_dir_has_best_weights = os.path.isdir(os.path.join(model_dir, "best_weights"))
    ...
    train_and_evaluate(train_model_spec, eval_model_spec, model_dir, params, restore_from)
